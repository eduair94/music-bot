    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        if (sub === "add") {
            ...
            await interaction.reply({ embeds: [new EmbedBuilder()
                .setTitle("➕ Personal Prefix Added")
                .setColor(0x2ecc71)
            ...
            await interaction.reply({ embeds: [new EmbedBuilder()
                .setTitle("➖ Personal Prefix Removed")
                .setColor(0xe74c3c)
            ...
            await interaction.reply({ embeds: [new EmbedBuilder()
                .setTitle("��� Personal Prefixes Reset")
                .setColor(0x2ecc71)
            ...
            await interaction.reply({ embeds: [new EmbedBuilder()
                .setTitle(enabled ? "��� Prefix Combining Enabled" : "��� Prefix Combining Disabled")
                .setColor(0x2ecc71)
