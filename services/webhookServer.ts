...
/**
 * @deprecated The webhook server is now optional. Webhooks can be handled by the
 * Next.js dashboard instead. Set USE_DASHBOARD_WEBHOOKS=true to use the dashboard.
 * 
 * Dashboard webhook endpoint: /api/webhooks/patreon
 * 
 * This standalone server is still useful for:
 * - Running without the dashboard
 * - Serving the static marketing website
 * - Development/testing of webhooks separately
 */
