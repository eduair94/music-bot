        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://discord.gg/bypass" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-[#5865f2] rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all">
                DC
              </a>
              <a href="https://github.com/eduair94/music-bot" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-white/20 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all">
                GH
              </a>
              <a href="https://www.patreon.com/cw/BypassDiscordBot" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/5 hover:bg-[#f96854] rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all">
                PT
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="https://discord.gg/bypass" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">Discord Server</a></li>
